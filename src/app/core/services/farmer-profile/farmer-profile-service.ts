...
export class FarmerProfileService {
  ...
  createAuctions(form:object):Observable<any>
  {
    /**
     * request
     * {
        "productId": 0,
        "startDate": "2026-06-16T15:06:20.184Z",
        "endDate": "2026-06-16T15:06:20.184Z",
        "startingPrice": 0,
        "reservePrice": 0
      }
     */
    return this.http.post(`${BaseUrl.url}api/Auctions`,form);
  }

  

  getMyAuctions(): Observable<ApiResponse<any[]>> {
    /*
    response
    {
  "isSuccess": true,
  ...
  "data": [
    {
      "id": 0,
      "status": "string",
      "startDate": "2026-06-16T15:28:40.711Z",
      "endDate": "2026-06-16T15:28:40.711Z",
      "startingPrice": 0,
      "currentPrice": 0,
      "totalBids": 0,
      "isEnded": true,
  ...
  "errors": [
    ...
    */
    return this.http.get<ApiResponse<any[]>>(`${BaseUrl.url}api/Auctions/my`)
  }
  ...
  getMyProducts(params: any): Observable<ApiResponse<any>> {
    let httpParams: any = {};
  ...
  editProduct(productData: any): Observable<ApiResponse<any>> {
    /**
     * request body
     * {
        "id": 0,
     ...
     */
    return this.http.put<ApiResponse<any>>(`${BaseUrl.url}api/Products`, productData)
  }
